               ...
               <div class="InformaçõesProf";>
                            ...
                            if($qtd > 0){
                                ...
                                while($row = $res->fetch_object()){
                                    ...
                                    echo "<img onclick=\"window.location.href='aluno.php?matricula=" . htmlspecialchars($row->id_prof, ENT_QUOTES, 'UTF-8') . "'\" src='Imagens/Informacoes.png' alt='Informações'>";
                                    echo "</div>";
                                    echo "</div>";
                                }
