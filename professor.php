<?php
    ...
    $sqlTurma = "select * from professor_turma inner join turma on turma.id = professor_turma.id_turma where professor_turma.id_prof ='{$prof}'";
    $resTurma = $conn->query($sqlTurma);

    // Seleciona as disciplinas atuais do professor
    $sqlDisciplina = "select * from professor_disciplina inner join disciplina on disciplina.id = professor_disciplina.id_disc where professor_disciplina.id_prof = '{$prof}'";
